...
if auth.is_logged_in():
    if auth.user.email.lower() in ["gdewey@insightmanagement.org", "himel@insightmanagement.org",
                                   "jason@insightmanagement.org", "rbanks@insightmanagement.org", "sdurgapasad@insightmanagement.org", "oalvarez@insightmanagement.org", "rtorres@insightmanagement.org",
                                   ]:
        my_role = "admin"
        IS_MASTER = True
    else:
